...
<div id="reviews">
					...
					<?php foreach ( $ratings as $rating ) : ?>
						...
						<tr>
							<td class="rating-number">
								<a href="<?php echo esc_url( $url ); ?>#comments"><?php echo $rating; ?> 
	...
	<div class="rating-form-container">
		<div class="review-form-button">
			<a href="javascript:;">LEAVE A REVIEW</a>
		</div>
		...
		<?php foreach ( $contribution_types as $type ) : ?>
			...
			<?php if ( 'contribution_comment' !== $type ) : $key++; ?>
				...
				<div id="<?php echo esc_attr( $type ); ?>_form_wrapper" class="contribution-form-wrapper <?php if ( $key === 1 ) : ?> <?php endif; ?>">
