...
?>
<?php
if($email->id == "customer_shipped_order"): // email shipped
	do_action( 'woocommerce_email_order_header_shipped', $order );	
else: // email processing
	do_action( 'woocommerce_email_order_header_processing', $order );
endif;
 ...
 */
do_action( 'woocommerce_email_customer_details', $order, $sent_to_admin, $plain_text, $email );
do_action('oa_shiping_payment_order_processing_email',$order);
endif;
...
if($email->id == "customer_shipped_order"): // email shipped
	...
	do_action('oa_footer_email_processing',$order);
endif;
