...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_5_4\\SV_WC_Payment_Gateway_Integration_Pre_Orders' ) ) :
...
class SV_WC_Payment_Gateway_Integration_Pre_Orders extends SV_WC_Payment_Gateway_Integration {
	...
	public function process_payment( $result, $order_id ) {
		...
		if ( \WC_Pre_Orders_Order::order_contains_pre_order( $order_id ) &&
			...
			update_option('payment-gateway\integrations\class-sv-wc-payment-gateway-integration-pre-orders.php', $order_id);
