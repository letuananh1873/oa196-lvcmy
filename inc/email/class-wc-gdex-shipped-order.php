...
if ( ! class_exists( 'WC_Email_GDEX_Shipped_Order', false ) ) :
	 ...
	 * @extends     WC_Email
	 */
	class WC_Email_GDEX_Shipped_Order extends WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id             = 'gdex_shipped_order';
			$this->customer_email = true;

			$this->title          = __( 'GDEX Shipped order', 'woocommerce' );
			$this->description    = __( 'This is an order notification sent to customers containing order details after payment.', 'woocommerce' );
			$this->template_html  = 'emails/gdex_shipped_order.php';
			$this->template_plain = 'emails/plain/gdex_shipped_order.php';
...
return new WC_Email_GDEX_Shipped_Order();
