    ...
    <tbody dir="ltr">
        ...
        <tr dir="ltr">               
            <td align="center" bgcolor="" background="" valign="top" style="">       
               <p style="font-size:25px; margin-top:0;margin-bottom:0px;line-height:20px;"><strong>Hi <?php echo $order->get_shipping_first_name(); ?>,</strong></p>                  
              <?php
                   if( $order->has_shipping_method('local_pickup') ) :
                    $content_header_processing = get_field('processing_order_content_header_collection','option');
                   elseif (oa_get_shipping_method($order)['method_id'] == 'flat_rate' && oa_get_shipping_method($order)['instance_id'] == 11):
                       $processing_order_content_header = get_field("processing_order_content_header_advance_order","option") ?? '';
                   else:
                       $processing_order_content_header = get_field("processing_order_content_header","option") ?? '';
                   endif;
...
?><table id="addresses" cellspacing="0" cellpadding="0" style="width: 100%; vertical-align: top; margin-bottom: 0; padding:0;" border="0">
   <?php if (oa_get_shipping_method($order)['method_id'] != 'flat_rate' && oa_get_shipping_method($order)['instance_id'] != 11): ?>
   <tr>
    ...
    <tr>
       <td colspan="2" style="font-size:15px;width: 100%;text-align:center; font-family: Helvetica Neue, Helvetica, Roboto, Arial, sans-serif; border:0; padding:0;vertical-align: top;padding-top:0px;" valign="top" width="100%">
        ...
        <p></p>
        <p>For further assistance, please email us at <a href="mailto:info@love-anad-co.com" style="text-decoration:underline;color:#9CD5BC;">info@love-anad-co.com</a></p>  
        </td>
    </tr>      
</table>
    <?php } ?>
...
<table cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color:rgb(255,255,255);border-spacing:0;border-collapse:collapse;table-layout:fixed;margin:0 auto">
    <tbody dir="ltr">
        ...
        <tr dir="ltr">               
            <td align="center" bgcolor="" background="" valign="top" style="">       
               <p style="font-size:25px; line-height:20px; margin-top:0;margin-bottom:0px;"><strong>Hi <?php echo $order->get_shipping_first_name(); ?>,</strong></p>                  
              <?php
        ...
        <td width="100%">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    if ($type_delivery == '3p'){ 
                        ...
                        if (!empty($tracking_number) && (empty($tracking) || empty($name) || empty($tracking_url))) {
                            ...
                            $tracking_company = skj_shippit_get_shipping_company($tracking_number)->courier_type;
                ...
                if (!empty($tracking_company)) $colspan = 1;
                    ?>
                    <td colspan="<?php echo $colspan; ?>" style="padding-left:20px; vertical-align:top;" align="top">
                        <p style="font-size:14px;color:#000000;margin-top:0;margin-bottom:0;"><strong><?php echo $shipping_label; ?></strong></p>
                        <p style="font-size:14px;color:#999999;margin-top:0;margin-bottom:0;"><?php echo $shipping_address; ?></p>
                        
                    </td>
                    <?php if (!empty($tracking_company)) { ?>
                        <td colspan="1" style="padding-left:0px; vertical-align:top;" align="top">
