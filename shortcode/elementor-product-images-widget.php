...
class Elementor_Product_Image_Widget extends Widget_Base {

	public function get_name() {
		return 'alt-product-images';
	}

	public function get_title() {
		return __( 'ALT - Product Images', 'elementor-pro' );
	}
	...
	public function render() {
		...
		include get_template_directory() . '/func-custom/alt-swatches/product-images.php';
